...
const ClientDeleteModal = () => {
    return(
        <>
        <div className="modal fade" id="clientDeleteModal">
          <div className="modal-dialog modal-lg modal-dialog-centered userDelete-modal modal-dialog-scrollable">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div id="clientDelete-modal" className="text-center my-3">
                    <h3>Are you sure you want to delete this user !</h3>
                </div>
                <div className="text-center  my-2">
                    <button className="theme-btn small btn-style-one ">Yes</button>
                    <button  
