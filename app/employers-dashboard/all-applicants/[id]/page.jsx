...
const Index = () => {
    ...
    return(
      ...
      <MobileMenu />
        ...
        <div className="d-flex justify-content-between pt-5 pb-3  mt-4 gap-3">
        <div className="d-flex  gap-3">
            ...
            <div className="">
                <div className="d-flex ">
                    ...
                    <div className="border border-secondary position-relative px-2">
                        ...
                        {submitOpt &&
                            <div className="position-absolute bg-secondary border border-secondary rounded-1 px-2" style={{width:'200px', height:'80px', top:'30px', zIndex:'1000', right:0}}>
                                 <Link href={`/employers-dashboard/all-applicants/submit_jobs/${id}`}>
            ...
            {tab == 3 &&
                <>
                <Experience applicantDetails={applicantData} handleGetApplicantDetails={handleGetApplicantDetails}  />
                <EducationDetails applicantDetails={applicantData} handleGetApplicantDetails={handleGetApplicantDetails} />
                <Certificate applicantDetails={applicantData} handleGetApplicantDetails={handleGetApplicantDetails} />
                <Languages applicantDetails={applicantData} handleGetApplicantDetails={handleGetApplicantDetails} />
                </>
            }
            {tab == 1  &&
            <div>
